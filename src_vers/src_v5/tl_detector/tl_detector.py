...
class TLDetector(object):
    ...
    def get_light_state(self, light):
        ...
        # save/capture  image files to determine 
        # appropriate distance from light stop line for precise/accurate classification
        # cv2.imwrite('imgs/'+'test.jpg', cv_image)        
        file_name = 'imgs/'+str(time.time() * 100)+'_'+str(self.diff_cpsl)+'.jpg'
